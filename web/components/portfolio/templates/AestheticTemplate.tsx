    ...
    >
      {(first || (heroMode && sigPair)) && (
        <header className="flex min-h-screen flex-col justify-center gap-16 px-6 py-24 md:px-12">
          {first && (
            <div className="mx-auto max-w-4xl text-center font-serif text-4xl leading-tight tracking-tight text-balance md:text-7xl md:leading-[1.05]">
          ...
          <div
            ...
            className={
              i % 3 === 0
                ? "w-full"
                : i % 3 === 1
                  ? "mx-auto w-full max-w-4xl md:ml-0 md:w-2/3"
                  : "mx-auto w-full max-w-2xl md:mr-0 md:ml-auto md:w-2/3"
            }
          >
