...
-- Public portfolio chat transcripts are persisted through the server-only chat
-- API. Do not grant anon direct access to conversations.
...
-- Public portfolio chat transcripts are persisted through the server-only chat
-- API. Do not grant anon direct access to messages.
